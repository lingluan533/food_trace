...
router.post('/addFood', (req, res) => {
    var sql = $sql.food.add;
    var params = req.body;
    console.log(params);
    console.log(params.birth);
    conn.query(sql, [params.blockchainId, params.foodName,dateStr(params.productDate) , params.exp,
                    params.manufacturer, params.advicePrice, params.serialNumber,params.imgHash,params.status ], function(err, result) {
        if (err) {
            console.log(err);
        }
        if (result) {
